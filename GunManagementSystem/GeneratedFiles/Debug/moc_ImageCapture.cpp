...
QT_MOC_LITERAL(1, 14, 16), // "SendCaptureImage"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 3), // "Mat"
QT_MOC_LITERAL(4, 36, 3) // "img"

    },
    "CImageCapture\0SendCaptureImage\0\0Mat\0"
    "img"
};
...
void CImageCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SendCaptureImage((*reinterpret_cast< Mat(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CImageCapture::*)(Mat );
...
// SIGNAL 0
void CImageCapture::SendCaptureImage(Mat _t1)
{
