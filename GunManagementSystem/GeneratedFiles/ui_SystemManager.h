...
public:
    ...
    QPushButton *pushButton_PrintBox;
    QSpacerItem *horizontalSpacer_12;
    QPushButton *pushButton_BoxDetailsReturn;
    QWidget *tab;
...
"color: rgb(41, 136, 41);"));
        ...
        pushButton_QueryInfo->setMinimumSize(QSize(75, 75));
        pushButton_QueryInfo->setMaximumSize(QSize(100, 100));
        pushButton_QueryInfo->setStyleSheet(QString::fromUtf8("font: 75 20pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";\n"
"background-color: rgb(41, 136, 41);\n"
"color: rgb(255, 255, 255);"));

        horizontalLayout_8->addWidget(pushButton_QueryInfo);
        ...
        pushButton_ExportExcel->setMinimumSize(QSize(75, 75));
        pushButton_ExportExcel->setMaximumSize(QSize(100, 100));
        pushButton_ExportExcel->setStyleSheet(QString::fromUtf8("font: 75 20pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";\n"
"color: rgb(0, 170, 0);"));

        horizontalLayout_8->addWidget(pushButton_ExportExcel);
        ...
        gridLayout_2->addWidget(tableWidget_Search, 1, 0, 1, 1);
...
"color: rgb(85, 170, 0);"));
        ...
        gridLayout_2->addWidget(label_29, 2, 0, 1, 1);
...
"padding:2px 4px;"));
        ...
        horizontalLayout_6->addWidget(label_Remainder);
...
""));
        ...
        horizontalLayout_7->addWidget(pushButton_Deliver);
        ...
        gridLayout_13->addWidget(tableWidget_Delivery, 1, 0, 1, 1);
        ...
        pushButton_PrintBox = new QPushButton(tab_4);
        pushButton_PrintBox->setObjectName(QString::fromUtf8("pushButton_PrintBox"));
        pushButton_PrintBox->setMinimumSize(QSize(141, 30));
        pushButton_PrintBox->setMaximumSize(QSize(141, 30));
        pushButton_PrintBox->setStyleSheet(QString::fromUtf8("font: 75 15pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";\n"
"color: rgb(41, 136, 41);"));

        gridLayout_5->addWidget(pushButton_PrintBox, 1, 0, 1, 2);
        ...
        pushButton_BoxDetailsReturn = new QPushButton(tab_4);
        pushButton_BoxDetailsReturn->setObjectName(QString::fromUtf8("pushButton_BoxDetailsReturn"));
        pushButton_BoxDetailsReturn->setMinimumSize(QSize(75, 30));
        pushButton_BoxDetailsReturn->setMaximumSize(QSize(75, 30));
        pushButton_BoxDetailsReturn->setStyleSheet(QString::fromUtf8("font: 75 15pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));

        gridLayout_5->addWidget(pushButton_BoxDetailsReturn, 1, 3, 1, 1);
...
"color: rgb(85, 170, 0);"));
        ...
        lineEdit_Ocr->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 170, 127);\n"
"font: 14pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";\n"
"color: rgb(0, 0, 255);\n"
"border:2px groove yellow;\n"
"border-radius:50px;\n"
...
"background-color: rgb(215, 255, 197);\n"
"\n"
""));
...
"color: rgb(85, 170, 0);"));
        ...
        QWidget::setTabOrder(tableWidget_PackedInfo, pushButton_PrintBox);
        QWidget::setTabOrder(pushButton_PrintBox, pushButton_BoxDetailsReturn);
        QWidget::setTabOrder(pushButton_BoxDetailsReturn, pushButton_CodeGrab);
        ...
        QWidget::setTabOrder(pushButton_Modify, pushButton_InageGrabberReturn);
        QWidget::setTabOrder(pushButton_InageGrabberReturn, pushButton_Deliver);
        ...
        QObject::connect(pushButton_BoxDetailsReturn, SIGNAL(clicked()), SystemManager, SLOT(BoxDetailsReturn()));
        QObject::connect(pushButton_InageGrabberReturn, SIGNAL(clicked()), SystemManager, SLOT(ImageGrabberReturn()));
        ...
        QObject::connect(pushButton_PrintBox, SIGNAL(clicked()), SystemManager, SLOT(PrintBoxList()));
    ...
    void retranslateUi(QDialog *SystemManager)
    {
        ...
        pushButton_QueryBox->setShortcut(QCoreApplication::translate("SystemManager", "Return", nullptr));
...
#if QT_CONFIG(shortcut)
        pushButton_QuerySinglePacked->setShortcut(QCoreApplication::translate("SystemManager", "Return", nullptr));
#endif // QT_CONFIG(shortcut)
...
#if QT_CONFIG(shortcut)
        pushButton_PrintSinglePacked->setShortcut(QCoreApplication::translate("SystemManager", "Ctrl+P", nullptr));
#endif // QT_CONFIG(shortcut)
...
#if QT_CONFIG(shortcut)
        pushButton_QueryInfo->setShortcut(QCoreApplication::translate("SystemManager", "Return", nullptr));
#endif // QT_CONFIG(shortcut)
        pushButton_ExportExcel->setText(QCoreApplication::translate("SystemManager", "\345\257\274\345\207\272\n"
"Excel", nullptr));
...
#if QT_CONFIG(shortcut)
        pushButton_QueryDeliver->setShortcut(QCoreApplication::translate("SystemManager", "Return", nullptr));
#endif // QT_CONFIG(shortcut)
        ...
        pushButton_PrintBox->setText(QCoreApplication::translate("SystemManager", "\346\211\223\345\215\260\350\243\205\347\256\261\346\270\205\345\215\225", nullptr));
#if QT_CONFIG(shortcut)
        pushButton_PrintBox->setShortcut(QCoreApplication::translate("SystemManager", "Ctrl+P", nullptr));
#endif // QT_CONFIG(shortcut)
        pushButton_BoxDetailsReturn->setText(QCoreApplication::translate("SystemManager", "\350\277\224\345\233\236", nullptr));
